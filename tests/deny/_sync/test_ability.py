...
class TestCan:
    ...
    def test_raise_error_if_permission_not_defined_and_default_action_is_raise(
        self,
    ) -> None:
    ...
    def test_returns_true_of_permission_not_defined_and_default_action_is_allow(
        self,
    ):
        ability = Ability(default_action=Action.ALLOW)
        assert ability.can(ProjectPermissions.edit) is True

    def test_returns_false_of_permission_not_defined_and_default_action_is_deny(
        self,
    ):
